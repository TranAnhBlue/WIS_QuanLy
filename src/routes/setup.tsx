...
function SetupPage() {
  ...
  const handleReset = () => {
    ...
    try {
      // Add timestamps to demo users
      const usersWithTimestamps: User[] = DEMO_USERS.map((user) => ({
        ...user,
            ...
            <div className="flex gap-3">
              ...
              <div className="text-sm space-y-1">
                ...
                <ul className="list-disc list-inside space-y-1 text-muted-foreground">
                  <li>Dữ liệu được lưu trong <strong>localStorage</strong> (trình duyệt)</li>
                  <li>Nếu xóa cache trình duyệt, dữ liệu sẽ mất</li>
                  <li>Mật khẩu lưu dạng <strong>plain text</strong> (chỉ dùng cho demo)</li>
                  <li>Khi production cần chuyển sang database thật + hash password</li>
                </ul>
              </div>
            </div>
          </CardContent>
